...
class Security
{
	...
	public static function getUserGroups()
	{
		...
		$sql = "select ". $grConnection->addFieldWrappers( "Label" )
			." from ". $grConnection->addTableWrappers( "siinsan_uggroups" ) . " WHERE " . $grConnection->addFieldWrappers( "GroupID" )
	...
	*  For AD it is <provider code><username>
	...
	public static function getUgMembersDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "siinsan_ugmembers", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgGroupsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "siinsan_uggroups", $cman->getUserGroupsConnId() );
	}
	...
	public static function getUgRightsDatasource() {
		...
		global $cman;
		return getDbTableDataSource( "siinsan_ugrights", $cman->getUserGroupsConnId() );
	}
	...
	public static function  fillTablesOwnerId( $data, $provider ) {
		...
		if( $securityType == stAD && !$provider["useDbGroups"] ) {
			...
			storageSet( "_sp_pemrosesanakhir_OwnerID", $userId );
						storageSet( "_sp_pengangkutan_OwnerID", $userId );
						storageSet( "_sp_pengolahan_OwnerID", $userId );
						storageSet( "_sp_profil_OwnerID", $userId );
						storageSet( "_san_profil_OwnerID", $userId );
						storageSet( "_al_dataumum_OwnerID", $userId );
						storageSet( "_al_iplt_OwnerID", $userId );
						storageSet( "_dra_data_genangan_OwnerID", $userId );
						storageSet( "_sp_tparegional_OwnerID", $userId );
						storageSet( "_sp_banksampah_OwnerID", $userId );
						storageSet( "_san_spm_ald_OwnerID", $userId );
						storageSet( "_san_spm_ald_ver_OwnerID", $userId );
						storageSet( "_al_dataumum_tertentu_OwnerID", $userId );
						storageSet( "_al_dataumum_pemukiman_OwnerID", $userId );
						storageSet( "_san_rencanainduk_OwnerID", $userId );
						storageSet( "_san_peraturan_OwnerID", $userId );
						storageSet( "_al_dataumum_ver_prov_OwnerID", $userId );
						storageSet( "_al_dataumum_pemukiman_ver_prov_OwnerID", $userId );
						storageSet( "_al_dataumum_tertentu_ver_prov_OwnerID", $userId );
						storageSet( "_al_iplt_rev_prov_OwnerID", $userId );
						storageSet( "_al_iplt_rev_pusat_OwnerID", $userId );
						storageSet( "_san_rencanainduk_ver_prov_OwnerID", $userId );
						storageSet( "_san_rencanainduk_ver_OwnerID", $userId );
						storageSet( "_mne_umum_OwnerID", $userId );
						storageSet( "_mne_umum_kesiapan_OwnerID", $userId );
						storageSet( "_mne_umum_transisi_pelaksanaan_OwnerID", $userId );
						storageSet( "_mne_umum_pelaksanaan_OwnerID", $userId );
						storageSet( "_mne_umum_transisi_pasca_OwnerID", $userId );
						storageSet( "_mne_umum_pasca_OwnerID", $userId );
						storageSet( "_mne_umum_transisi_kesiapan_OwnerID", $userId );
						storageSet( "_sp_pemrosesanakhir_ver_prov_OwnerID", $userId );
						storageSet( "_sp_pemrosesanakhir_ver_OwnerID", $userId );
						storageSet( "_al_dataumum_pemukiman_ver_OwnerID", $userId );
						storageSet( "_al_dataumum_ver_OwnerID", $userId );
						storageSet( "_al_dataumum_tertentu_ver_OwnerID", $userId );
						storageSet( "_TPS3R_OwnerID", $userId );
						storageSet( "_Sanimas_OwnerID", $userId );
						storageSet( "_PadatKarya_OwnerID", $userId );
						storageSet( "_san_spm_ald_ver_prov_OwnerID", $userId );
						storageSet( "_sp_pengolahan_ver_prov_OwnerID", $userId );
						storageSet( "_sp_pengolahan_ver_OwnerID", $userId );
						storageSet( "_Sanimas_prov_OwnerID", $userId );
						storageSet( "_PadatKarya_prov_OwnerID", $userId );
						storageSet( "_TPS3R_prov_OwnerID", $userId );
						storageSet( "_mne_umum_kabkota_OwnerID", $userId );
						storageSet( "_sp_tparegional_ver_prov_OwnerID", $userId );
						storageSet( "_sp_tparegional_ver_OwnerID", $userId );
						storageSet( "_sp_banksampah_ver_OwnerID", $userId );
						storageSet( "_sp_banksampah_ver_prov_OwnerID", $userId );
						storageSet( "_v_kesiapan_eval_Report_OwnerID", $userId );
						storageSet( "_v_pelaksanaan_eval_Report_OwnerID", $userId );
						storageSet( "_v_pasca_eval_Report_OwnerID", $userId );
						storageSet( "_v_kesiapan_eval_total_Report_OwnerID", $userId );
						storageSet( "_v_pelaksanaan_eval_total_Report_OwnerID", $userId );
						storageSet( "_v_pasca_eval_total_Report_OwnerID", $userId );
						storageSet( "_v_kesiapan_eval_total_kategori_Report_OwnerID", $userId );
						storageSet( "_v_pelaksanaan_eval_total_kategori_Report_OwnerID", $userId );
						storageSet( "_v_pasca_eval_total_kategori_Report_OwnerID", $userId );
						storageSet( "_v_kesiapan_eval_prov_Report_OwnerID", $userId );
						storageSet( "_mne_umum_renonly_OwnerID", $userId );
						storageSet( "_mne_umum_verifiedonly_OwnerID", $userId );
						storageSet( "_sigdrainase_saluran_drainase_OwnerID", $userId );
						storageSet( "_dra_data_genangan_manual_OwnerID", $userId );
						storageSet( "_al_dataumum_prov_OwnerID", $userId );
						storageSet( "_al_dataumum_tertentu_prov_OwnerID", $userId );
						storageSet( "_al_dataumum_permukiman_prov_OwnerID", $userId );
						storageSet( "_al_iplt_prov_OwnerID", $userId );
						storageSet( "_sp_pemrosesanakhir_prov_OwnerID", $userId );
						storageSet( "_sp_tparegional_prov_OwnerID", $userId );
						storageSet( "_sp_pengolahan_prov_OwnerID", $userId );
						storageSet( "_sigdrainase_saluran_drainase_prov_OwnerID", $userId );
						storageSet( "_dra_data_genangan_prov_OwnerID", $userId );
						storageSet( "_al_spalds_OwnerID", $userId );
						storageSet( "_ibm_lpk_OwnerID", $userId );
						storageSet( "_al_spalds_prov_OwnerID", $userId );
						storageSet( "_dash_persampahan_kabkota_OwnerID", $userId );
						storageSet( "_dash_airlimbah_kabkota_OwnerID", $userId );
						storageSet( "_dash_airlimbah_prov_OwnerID", $userId );
						storageSet( "_dash_persampahan_prov_OwnerID", $userId );
						storageSet( "_dash_saluran_drainase_kabkota_OwnerID", $userId );
						storageSet( "_dash_saluran_drainase_prov_OwnerID", $userId );
						storageSet( "_dash_verifikasi_prov_kabkota_OwnerID", $userId );
						storageSet( "_dash_verifikasi_prov_prov_OwnerID", $userId );
						storageSet( "_dash_spaldt_infra_prov_OwnerID", $userId );
						storageSet( "_dash_spaldt_infra_kabkota_OwnerID", $userId );
						storageSet( "_dra_data_genangan_ver_prov_OwnerID", $userId );
						storageSet( "_sigdrainase_saluran_drainase_ver_prov_OwnerID", $userId );
						storageSet( "_dash_verifikasi_pusat_kabkota_OwnerID", $userId );
						storageSet( "_dash_verifikasi_pusat_prov_OwnerID", $userId );
						storageSet( "_mne_umum_sippa_OwnerID", $userId );
		} else {
						storageSet( "OwnerID", $data["r_kabupatenkotaid"] );
			storageSet( "_sp_pemrosesanakhir_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_pengangkutan_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_pengolahan_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_profil_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_profil_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_iplt_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dra_data_genangan_OwnerID", $data["kabkota_dra"] );
						storageSet( "_sp_tparegional_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_banksampah_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_spm_ald_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_spm_ald_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_tertentu_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_pemukiman_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_rencanainduk_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_peraturan_OwnerID", $data["kabkota_al"] );
						storageSet( "_al_dataumum_ver_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_dataumum_pemukiman_ver_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_dataumum_tertentu_ver_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_iplt_rev_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_iplt_rev_pusat_OwnerID", $data["kabkota_al"] );
						storageSet( "_san_rencanainduk_ver_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_san_rencanainduk_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_mne_umum_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_kesiapan_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_transisi_pelaksanaan_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_pelaksanaan_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_transisi_pasca_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_pasca_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_transisi_kesiapan_OwnerID", $data["prov_al"] );
						storageSet( "_sp_pemrosesanakhir_ver_prov_OwnerID", $data["usertype"] );
						storageSet( "_sp_pemrosesanakhir_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_pemukiman_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_dataumum_tertentu_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_TPS3R_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_Sanimas_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_PadatKarya_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_san_spm_ald_ver_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_sp_pengolahan_ver_prov_OwnerID", $data["usertype"] );
						storageSet( "_sp_pengolahan_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_Sanimas_prov_OwnerID", $data["usertype"] );
						storageSet( "_PadatKarya_prov_OwnerID", $data["usertype"] );
						storageSet( "_TPS3R_prov_OwnerID", $data["usertype"] );
						storageSet( "_mne_umum_kabkota_OwnerID", $data["kabkota_al"] );
						storageSet( "_sp_tparegional_ver_prov_OwnerID", $data["usertype"] );
						storageSet( "_sp_tparegional_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_banksampah_ver_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_sp_banksampah_ver_prov_OwnerID", $data["usertype"] );
						storageSet( "_v_kesiapan_eval_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pelaksanaan_eval_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pasca_eval_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_kesiapan_eval_total_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pelaksanaan_eval_total_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pasca_eval_total_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_kesiapan_eval_total_kategori_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pelaksanaan_eval_total_kategori_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_pasca_eval_total_kategori_Report_OwnerID", $data["kabkota_al"] );
						storageSet( "_v_kesiapan_eval_prov_Report_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_renonly_OwnerID", $data["prov_al"] );
						storageSet( "_mne_umum_verifiedonly_OwnerID", $data["prov_al"] );
						storageSet( "_sigdrainase_saluran_drainase_OwnerID", $data["kabkota_dra"] );
						storageSet( "_dra_data_genangan_manual_OwnerID", $data["kabkota_dra"] );
						storageSet( "_al_dataumum_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_dataumum_tertentu_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_dataumum_permukiman_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_al_iplt_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_sp_pemrosesanakhir_prov_OwnerID", $data["usertype"] );
						storageSet( "_sp_tparegional_prov_OwnerID", $data["usertype"] );
						storageSet( "_sp_pengolahan_prov_OwnerID", $data["usertype"] );
						storageSet( "_sigdrainase_saluran_drainase_prov_OwnerID", $data["prov_dra"] );
						storageSet( "_dra_data_genangan_prov_OwnerID", $data["prov_dra"] );
						storageSet( "_al_spalds_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_ibm_lpk_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_al_spalds_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_dash_persampahan_kabkota_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dash_airlimbah_kabkota_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dash_airlimbah_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_dash_persampahan_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_dash_saluran_drainase_kabkota_OwnerID", $data["kabkota_al"] );
						storageSet( "_dash_saluran_drainase_prov_OwnerID", $data["prov_dra"] );
						storageSet( "_dash_verifikasi_prov_kabkota_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dash_verifikasi_prov_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_dash_spaldt_infra_prov_OwnerID", $data["r_provinsiid"] );
						storageSet( "_dash_spaldt_infra_kabkota_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dra_data_genangan_ver_prov_OwnerID", $data["prov_dra"] );
						storageSet( "_sigdrainase_saluran_drainase_ver_prov_OwnerID", $data["prov_dra"] );
						storageSet( "_dash_verifikasi_pusat_kabkota_OwnerID", $data["r_kabupatenkotaid"] );
						storageSet( "_dash_verifikasi_pusat_prov_OwnerID", $data["r_prov"] );
						storageSet( "_mne_umum_sippa_OwnerID", $data["prov_al"] );
		}
	}
