...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("v_tpa_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_tpa_jumlah_bytahun_chart",
				"table"=>"v_tpa_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_tparegional_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_tparegional_jumlah_bytahun_chart",
				"table"=>"v_tparegional_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_tps3r_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_tps3r_jumlah_bytahun_chart",
				"table"=>"v_tps3r_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_tpst_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_tpst_jumlah_bytahun_chart",
				"table"=>"v_tpst_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_iplt_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_iplt_jumlah_bytahun_chart",
				"table"=>"v_iplt_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_sanimas_jumlah_by_tahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_sanimas_jumlah_by_tahun_chart",
				"table"=>"v_sanimas_jumlah_by_tahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_spaldt_pemukiman_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_spaldt_pemukiman_jumlah_bytahun_chart",
				"table"=>"v_spaldt_pemukiman_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_spaldt_perkotaan_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_spaldt_perkotaan_jumlah_bytahun_chart",
				"table"=>"v_spaldt_perkotaan_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_spaldt_tertentu_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_spaldt_tertentu_jumlah_bytahun_chart",
				"table"=>"v_spaldt_tertentu_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("v_banksampah_jumlah_bytahun_chart_chart","xt_showchart",
			array(
				"chartName"=>"v_banksampah_jumlah_bytahun_chart",
				"table"=>"v_banksampah_jumlah_bytahun_Chart",
				"ctype"=>"2DColumn"));
		}
