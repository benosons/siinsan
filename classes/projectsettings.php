...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("user", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "t_kabupatenkota" ] = array( "url" => "t_kabupatenkota", "type" => 0 );
	$projectEntitiesReverse[ "t_kabupatenkota" ] = "t_kabupatenkota";
	$projectEntities[ "t_provinsi" ] = array( "url" => "t_provinsi", "type" => 0 );
	$projectEntitiesReverse[ "t_provinsi" ] = "t_provinsi";
	...
	$projectEntities[ "sp_pemrosesanakhir" ] = array( "url" => "sp_pemrosesanakhir", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir" ] = "sp_pemrosesanakhir";
	$projectEntities[ "sp_pemrosesanakhir_jenis" ] = array( "url" => "sp_pemrosesanakhir_jenis", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_jenis" ] = "sp_pemrosesanakhir_jenis";
	$projectEntities[ "sp_pemrosesanakhir_kondisi" ] = array( "url" => "sp_pemrosesanakhir_kondisi", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_kondisi" ] = "sp_pemrosesanakhir_kondisi";
	$projectEntities[ "sp_pemrosesanakhir_kategoripelayanan" ] = array( "url" => "sp_pemrosesanakhir_kategoripelayanan", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_kategoripelayanan" ] = "sp_pemrosesanakhir_kategoripelayanan";
	$projectEntities[ "sp_pemrosesanakhir_jenispengelola" ] = array( "url" => "sp_pemrosesanakhir_jenispengelola", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_jenispengelola" ] = "sp_pemrosesanakhir_jenispengelola";
	$projectEntities[ "t_sumber_dana_pembangunan" ] = array( "url" => "t_sumber_dana_pembangunan", "type" => 0 );
	$projectEntitiesReverse[ "t_sumber_dana_pembangunan" ] = "t_sumber_dana_pembangunan";
	$projectEntities[ "t_ada_tidak" ] = array( "url" => "t_ada_tidak", "type" => 0 );
	$projectEntitiesReverse[ "t_ada_tidak" ] = "t_ada_tidak";
	$projectEntities[ "t_ba_status_aset" ] = array( "url" => "t_ba_status_aset", "type" => 0 );
	$projectEntitiesReverse[ "t_ba_status_aset" ] = "t_ba_status_aset";
	$projectEntities[ "sp_pengangkutan" ] = array( "url" => "sp_pengangkutan", "type" => 0 );
	$projectEntitiesReverse[ "sp_pengangkutan" ] = "sp_pengangkutan";
	$projectEntities[ "sp_pengolahan" ] = array( "url" => "sp_pengolahan", "type" => 0 );
	$projectEntitiesReverse[ "sp_pengolahan" ] = "sp_pengolahan";
	$projectEntities[ "sp_profil" ] = array( "url" => "sp_profil", "type" => 0 );
	$projectEntitiesReverse[ "sp_profil" ] = "sp_profil";
	$projectEntities[ "san_profil" ] = array( "url" => "san_profil", "type" => 0 );
	$projectEntitiesReverse[ "san_profil" ] = "san_profil";
	$projectEntities[ "t_ada_rusak_tidak" ] = array( "url" => "t_ada_rusak_tidak", "type" => 0 );
	$projectEntitiesReverse[ "t_ada_rusak_tidak" ] = "t_ada_rusak_tidak";
	$projectEntities[ "al_dataumum" ] = array( "url" => "al_dataumum", "type" => 0 );
	$projectEntitiesReverse[ "al_dataumum" ] = "al_dataumum";
	$projectEntities[ "t_al_provinsi" ] = array( "url" => "t_al_provinsi", "type" => 0 );
	$projectEntitiesReverse[ "t_al_provinsi" ] = "t_al_provinsi";
	$projectEntities[ "t_al_kabupatenkota" ] = array( "url" => "t_al_kabupatenkota", "type" => 0 );
	$projectEntitiesReverse[ "t_al_kabupatenkota" ] = "t_al_kabupatenkota";
	$projectEntities[ "t_al_kecamatan" ] = array( "url" => "t_al_kecamatan", "type" => 0 );
	$projectEntitiesReverse[ "t_al_kecamatan" ] = "t_al_kecamatan";
	$projectEntities[ "t_al_kelurahan" ] = array( "url" => "t_al_kelurahan", "type" => 0 );
	$projectEntitiesReverse[ "t_al_kelurahan" ] = "t_al_kelurahan";
	$projectEntities[ "dra_data_umum" ] = array( "url" => "dra_data_umum", "type" => 0 );
	$projectEntitiesReverse[ "dra_data_umum" ] = "dra_data_umum";
	$projectEntities[ "t_dra_propinsi" ] = array( "url" => "t_dra_propinsi", "type" => 0 );
	$projectEntitiesReverse[ "t_dra_propinsi" ] = "t_dra_propinsi";
	$projectEntities[ "t_dra_kota" ] = array( "url" => "t_dra_kota", "type" => 0 );
	$projectEntitiesReverse[ "t_dra_kota" ] = "t_dra_kota";
	$projectEntities[ "t_dra_kecamatan" ] = array( "url" => "t_dra_kecamatan", "type" => 0 );
	$projectEntitiesReverse[ "t_dra_kecamatan" ] = "t_dra_kecamatan";
	$projectEntities[ "t_dra_kelurahan" ] = array( "url" => "t_dra_kelurahan", "type" => 0 );
	$projectEntitiesReverse[ "t_dra_kelurahan" ] = "t_dra_kelurahan";
	$projectEntities[ "al_cakupanairlimbah" ] = array( "url" => "al_cakupanairlimbah", "type" => 0 );
	$projectEntitiesReverse[ "al_cakupanairlimbah" ] = "al_cakupanairlimbah";
	$projectEntities[ "al_sdm_institusi" ] = array( "url" => "al_sdm_institusi", "type" => 0 );
	$projectEntitiesReverse[ "al_sdm_institusi" ] = "al_sdm_institusi";
	$projectEntities[ "al_sdm_pengelola" ] = array( "url" => "al_sdm_pengelola", "type" => 0 );
	$projectEntitiesReverse[ "al_sdm_pengelola" ] = "al_sdm_pengelola";
	$projectEntities[ "al_iplt" ] = array( "url" => "al_iplt", "type" => 0 );
	$projectEntitiesReverse[ "al_iplt" ] = "al_iplt";
	$projectEntities[ "al_kualitasair" ] = array( "url" => "al_kualitasair", "type" => 0 );
	$projectEntitiesReverse[ "al_kualitasair" ] = "al_kualitasair";
	$projectEntities[ "al_mck" ] = array( "url" => "al_mck", "type" => 0 );
	$projectEntitiesReverse[ "al_mck" ] = "al_mck";
	$projectEntities[ "al_babs_penderita" ] = array( "url" => "al_babs_penderita", "type" => 0 );
	$projectEntitiesReverse[ "al_babs_penderita" ] = "al_babs_penderita";
	$projectEntities[ "al_penggunasaranabab" ] = array( "url" => "al_penggunasaranabab", "type" => 0 );
	$projectEntitiesReverse[ "al_penggunasaranabab" ] = "al_penggunasaranabab";
	$projectEntities[ "t_al_sektor" ] = array( "url" => "t_al_sektor", "type" => 0 );
	$projectEntitiesReverse[ "t_al_sektor" ] = "t_al_sektor";
	$projectEntities[ "al_programkegiatan" ] = array( "url" => "al_programkegiatan", "type" => 0 );
	$projectEntitiesReverse[ "al_programkegiatan" ] = "al_programkegiatan";
	$projectEntities[ "al_setempat" ] = array( "url" => "al_setempat", "type" => 0 );
	$projectEntitiesReverse[ "al_setempat" ] = "al_setempat";
	$projectEntities[ "al_peranserta" ] = array( "url" => "al_peranserta", "type" => 0 );
	$projectEntitiesReverse[ "al_peranserta" ] = "al_peranserta";
	$projectEntities[ "dra_t_jenis_bahan" ] = array( "url" => "dra_t_jenis_bahan", "type" => 0 );
	$projectEntitiesReverse[ "dra_t_jenis_bahan" ] = "dra_t_jenis_bahan";
	$projectEntities[ "dra_data_genangan" ] = array( "url" => "dra_data_genangan", "type" => 0 );
	$projectEntitiesReverse[ "dra_data_genangan" ] = "dra_data_genangan";
	$projectEntities[ "dra_data_pembiayaan" ] = array( "url" => "dra_data_pembiayaan", "type" => 0 );
	$projectEntitiesReverse[ "dra_data_pembiayaan" ] = "dra_data_pembiayaan";
	$projectEntities[ "dra_t_bentuk_saluran" ] = array( "url" => "dra_t_bentuk_saluran", "type" => 0 );
	$projectEntitiesReverse[ "dra_t_bentuk_saluran" ] = "dra_t_bentuk_saluran";
	$projectEntities[ "dra_t_jenis_bangunan" ] = array( "url" => "dra_t_jenis_bangunan", "type" => 0 );
	$projectEntitiesReverse[ "dra_t_jenis_bangunan" ] = "dra_t_jenis_bangunan";
	$projectEntities[ "mne_t_sektor" ] = array( "url" => "mne_t_sektor", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_sektor" ] = "mne_t_sektor";
	$projectEntities[ "mne_t_jenis_infrastruktur" ] = array( "url" => "mne_t_jenis_infrastruktur", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_jenis_infrastruktur" ] = "mne_t_jenis_infrastruktur";
	$projectEntities[ "mne_t_sumberdana" ] = array( "url" => "mne_t_sumberdana", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_sumberdana" ] = "mne_t_sumberdana";
	$projectEntities[ "mne_t_statususulan" ] = array( "url" => "mne_t_statususulan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_statususulan" ] = "mne_t_statususulan";
	$projectEntities[ "mne_t_kategori_perencanaan" ] = array( "url" => "mne_t_kategori_perencanaan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_kategori_perencanaan" ] = "mne_t_kategori_perencanaan";
	$projectEntities[ "mne_t_tahap_perencanaan" ] = array( "url" => "mne_t_tahap_perencanaan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_tahap_perencanaan" ] = "mne_t_tahap_perencanaan";
	$projectEntities[ "mne_t_sub_tahap_perencanaan" ] = array( "url" => "mne_t_sub_tahap_perencanaan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_sub_tahap_perencanaan" ] = "mne_t_sub_tahap_perencanaan";
	$projectEntities[ "mne_t_param_sub_tahap_perencanaan" ] = array( "url" => "mne_t_param_sub_tahap_perencanaan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_param_sub_tahap_perencanaan" ] = "mne_t_param_sub_tahap_perencanaan";
	$projectEntities[ "mne_t_pelaksanaan_konstruksi" ] = array( "url" => "mne_t_pelaksanaan_konstruksi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_pelaksanaan_konstruksi" ] = "mne_t_pelaksanaan_konstruksi";
	$projectEntities[ "mne_t_sub_pelaksanaan_konstruksi" ] = array( "url" => "mne_t_sub_pelaksanaan_konstruksi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_sub_pelaksanaan_konstruksi" ] = "mne_t_sub_pelaksanaan_konstruksi";
	$projectEntities[ "mne_t_param_sub_pelaksanaan" ] = array( "url" => "mne_t_param_sub_pelaksanaan", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_param_sub_pelaksanaan" ] = "mne_t_param_sub_pelaksanaan";
	$projectEntities[ "san_spm_stbm" ] = array( "url" => "san_spm_stbm", "type" => 0 );
	$projectEntitiesReverse[ "san_spm_stbm" ] = "san_spm_stbm";
	$projectEntities[ "ssk_file" ] = array( "url" => "ssk_file", "type" => 0 );
	$projectEntitiesReverse[ "ssk_file" ] = "ssk_file";
	$projectEntities[ "ssk_dokumen" ] = array( "url" => "ssk_dokumen", "type" => 0 );
	$projectEntitiesReverse[ "ssk_dokumen" ] = "ssk_dokumen";
	$projectEntities[ "ssk_tahun" ] = array( "url" => "ssk_tahun", "type" => 0 );
	$projectEntitiesReverse[ "ssk_tahun" ] = "ssk_tahun";
	$projectEntities[ "ssk_pokja" ] = array( "url" => "ssk_pokja", "type" => 0 );
	$projectEntitiesReverse[ "ssk_pokja" ] = "ssk_pokja";
	$projectEntities[ "san_profil_ver" ] = array( "url" => "san_profil_ver", "type" => 1 );
	$projectEntitiesReverse[ "san_profil_ver" ] = "san_profil_ver";
	$projectEntities[ "t_verifikasi" ] = array( "url" => "t_verifikasi", "type" => 0 );
	$projectEntitiesReverse[ "t_verifikasi" ] = "t_verifikasi";
	$projectEntities[ "san_spm_stbm_ver" ] = array( "url" => "san_spm_stbm_ver", "type" => 1 );
	$projectEntitiesReverse[ "san_spm_stbm_ver" ] = "san_spm_stbm_ver";
	$projectEntities[ "sp_pemrosesanakhir_sistem" ] = array( "url" => "sp_pemrosesanakhir_sistem", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_sistem" ] = "sp_pemrosesanakhir_sistem";
	$projectEntities[ "t_dimanfaatkan" ] = array( "url" => "t_dimanfaatkan", "type" => 0 );
	$projectEntitiesReverse[ "t_dimanfaatkan" ] = "t_dimanfaatkan";
	$projectEntities[ "sp_tparegional" ] = array( "url" => "sp_tparegional", "type" => 1 );
	$projectEntitiesReverse[ "sp_tparegional" ] = "sp_tparegional";
	$projectEntities[ "sp_profil_prov" ] = array( "url" => "sp_profil_prov", "type" => 0 );
	$projectEntitiesReverse[ "sp_profil_prov" ] = "sp_profil_prov";
	$projectEntities[ "sp_banksampah" ] = array( "url" => "sp_banksampah", "type" => 0 );
	$projectEntitiesReverse[ "sp_banksampah" ] = "sp_banksampah";
	$projectEntities[ "san_spm_ald" ] = array( "url" => "san_spm_ald", "type" => 0 );
	$projectEntitiesReverse[ "san_spm_ald" ] = "san_spm_ald";
	$projectEntities[ "t_kecamatan" ] = array( "url" => "t_kecamatan", "type" => 0 );
	$projectEntitiesReverse[ "t_kecamatan" ] = "t_kecamatan";
	$projectEntities[ "t_kelurahan" ] = array( "url" => "t_kelurahan", "type" => 0 );
	$projectEntitiesReverse[ "t_kelurahan" ] = "t_kelurahan";
	$projectEntities[ "san_spm_ald_ver" ] = array( "url" => "san_spm_ald_ver", "type" => 1 );
	$projectEntitiesReverse[ "san_spm_ald_ver" ] = "san_spm_ald_ver";
	$projectEntities[ "al_dataumum_tertentu" ] = array( "url" => "al_dataumum_tertentu", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_tertentu" ] = "al_dataumum_tertentu";
	$projectEntities[ "al_dataumum_pemukiman" ] = array( "url" => "al_dataumum_pemukiman", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_pemukiman" ] = "al_dataumum_pemukiman";
	$projectEntities[ "v_tpa_Report" ] = array( "url" => "v_tpa_report", "type" => 2 );
	$projectEntitiesReverse[ "v_tpa_report" ] = "v_tpa_Report";
	$projectEntities[ "v_tpa_stat_Report" ] = array( "url" => "v_tpa_stat_report", "type" => 2 );
	$projectEntitiesReverse[ "v_tpa_stat_report" ] = "v_tpa_stat_Report";
	$projectEntities[ "usertype" ] = array( "url" => "usertype", "type" => 0 );
	$projectEntitiesReverse[ "usertype" ] = "usertype";
	$projectEntities[ "mne_t_pasca_konstruksi" ] = array( "url" => "mne_t_pasca_konstruksi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_pasca_konstruksi" ] = "mne_t_pasca_konstruksi";
	$projectEntities[ "mne_t_sub_pasca_konstruksi" ] = array( "url" => "mne_t_sub_pasca_konstruksi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_sub_pasca_konstruksi" ] = "mne_t_sub_pasca_konstruksi";
	$projectEntities[ "mne_t_param_sub_pasca_konstruksi" ] = array( "url" => "mne_t_param_sub_pasca_konstruksi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_param_sub_pasca_konstruksi" ] = "mne_t_param_sub_pasca_konstruksi";
	$projectEntities[ "mne_t_kriteria_evaluasi" ] = array( "url" => "mne_t_kriteria_evaluasi", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_kriteria_evaluasi" ] = "mne_t_kriteria_evaluasi";
	$projectEntities[ "t_aktif" ] = array( "url" => "t_aktif", "type" => 0 );
	$projectEntitiesReverse[ "t_aktif" ] = "t_aktif";
	$projectEntities[ "san_rencanainduk" ] = array( "url" => "san_rencanainduk", "type" => 0 );
	$projectEntitiesReverse[ "san_rencanainduk" ] = "san_rencanainduk";
	$projectEntities[ "v_tpa_jumlah_bytahun_Chart" ] = array( "url" => "v_tpa_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_tpa_jumlah_bytahun_chart" ] = "v_tpa_jumlah_bytahun_Chart";
	$projectEntities[ "v_tparegional_jumlah_bytahun_Chart" ] = array( "url" => "v_tparegional_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_tparegional_jumlah_bytahun_chart" ] = "v_tparegional_jumlah_bytahun_Chart";
	$projectEntities[ "v_tps3r_jumlah_bytahun_Chart" ] = array( "url" => "v_tps3r_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_tps3r_jumlah_bytahun_chart" ] = "v_tps3r_jumlah_bytahun_Chart";
	$projectEntities[ "v_tpst_jumlah_bytahun_Chart" ] = array( "url" => "v_tpst_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_tpst_jumlah_bytahun_chart" ] = "v_tpst_jumlah_bytahun_Chart";
	$projectEntities[ "v_iplt_jumlah_bytahun_Chart" ] = array( "url" => "v_iplt_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_iplt_jumlah_bytahun_chart" ] = "v_iplt_jumlah_bytahun_Chart";
	$projectEntities[ "v_sanimas_jumlah_by_tahun_Chart" ] = array( "url" => "v_sanimas_jumlah_by_tahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_sanimas_jumlah_by_tahun_chart" ] = "v_sanimas_jumlah_by_tahun_Chart";
	$projectEntities[ "v_spaldt_pemukiman_jumlah_bytahun_Chart" ] = array( "url" => "v_spaldt_pemukiman_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_spaldt_pemukiman_jumlah_bytahun_chart" ] = "v_spaldt_pemukiman_jumlah_bytahun_Chart";
	$projectEntities[ "v_spaldt_perkotaan_jumlah_bytahun_Chart" ] = array( "url" => "v_spaldt_perkotaan_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_spaldt_perkotaan_jumlah_bytahun_chart" ] = "v_spaldt_perkotaan_jumlah_bytahun_Chart";
	$projectEntities[ "v_spaldt_tertentu_jumlah_bytahun_Chart" ] = array( "url" => "v_spaldt_tertentu_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_spaldt_tertentu_jumlah_bytahun_chart" ] = "v_spaldt_tertentu_jumlah_bytahun_Chart";
	$projectEntities[ "v_banksampah_jumlah_bytahun_Chart" ] = array( "url" => "v_banksampah_jumlah_bytahun_chart", "type" => 3 );
	$projectEntitiesReverse[ "v_banksampah_jumlah_bytahun_chart" ] = "v_banksampah_jumlah_bytahun_Chart";
	$projectEntities[ "Dashboard" ] = array( "url" => "dashboard", "type" => 4 );
	$projectEntitiesReverse[ "dashboard" ] = "Dashboard";
	$projectEntities[ "v_dra_lokasi_genangan_Report" ] = array( "url" => "v_dra_lokasi_genangan_report", "type" => 2 );
	$projectEntitiesReverse[ "v_dra_lokasi_genangan_report" ] = "v_dra_lokasi_genangan_Report";
	$projectEntities[ "san_peraturan" ] = array( "url" => "san_peraturan", "type" => 0 );
	$projectEntitiesReverse[ "san_peraturan" ] = "san_peraturan";
	$projectEntities[ "t_jenis_peraturan" ] = array( "url" => "t_jenis_peraturan", "type" => 0 );
	$projectEntitiesReverse[ "t_jenis_peraturan" ] = "t_jenis_peraturan";
	$projectEntities[ "sp_tpa_alatberat" ] = array( "url" => "sp_tpa_alatberat", "type" => 0 );
	$projectEntitiesReverse[ "sp_tpa_alatberat" ] = "sp_tpa_alatberat";
	$projectEntities[ "sp_tpa_saranapengangkutan" ] = array( "url" => "sp_tpa_saranapengangkutan", "type" => 0 );
	$projectEntitiesReverse[ "sp_tpa_saranapengangkutan" ] = "sp_tpa_saranapengangkutan";
	$projectEntities[ "sp_t_jenis_alatberat" ] = array( "url" => "sp_t_jenis_alatberat", "type" => 0 );
	$projectEntitiesReverse[ "sp_t_jenis_alatberat" ] = "sp_t_jenis_alatberat";
	$projectEntities[ "t_kondisi" ] = array( "url" => "t_kondisi", "type" => 0 );
	$projectEntitiesReverse[ "t_kondisi" ] = "t_kondisi";
	$projectEntities[ "sp_t_jenis_saranaangkut" ] = array( "url" => "sp_t_jenis_saranaangkut", "type" => 0 );
	$projectEntitiesReverse[ "sp_t_jenis_saranaangkut" ] = "sp_t_jenis_saranaangkut";
	$projectEntities[ "t_status_lahan" ] = array( "url" => "t_status_lahan", "type" => 0 );
	$projectEntitiesReverse[ "t_status_lahan" ] = "t_status_lahan";
	$projectEntities[ "al_t_jenis_infrastruktur" ] = array( "url" => "al_t_jenis_infrastruktur", "type" => 0 );
	$projectEntitiesReverse[ "al_t_jenis_infrastruktur" ] = "al_t_jenis_infrastruktur";
	$projectEntities[ "al_cakupanairlimbah_pemukiman" ] = array( "url" => "al_cakupanairlimbah_pemukiman", "type" => 1 );
	$projectEntitiesReverse[ "al_cakupanairlimbah_pemukiman" ] = "al_cakupanairlimbah_pemukiman";
	$projectEntities[ "al_cakupanairlimbah_tertentu" ] = array( "url" => "al_cakupanairlimbah_tertentu", "type" => 1 );
	$projectEntitiesReverse[ "al_cakupanairlimbah_tertentu" ] = "al_cakupanairlimbah_tertentu";
	$projectEntities[ "al_dataumum_ver_prov" ] = array( "url" => "al_dataumum_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_ver_prov" ] = "al_dataumum_ver_prov";
	$projectEntities[ "al_dataumum_pemukiman_ver_prov" ] = array( "url" => "al_dataumum_pemukiman_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_pemukiman_ver_prov" ] = "al_dataumum_pemukiman_ver_prov";
	$projectEntities[ "al_dataumum_tertentu_ver_prov" ] = array( "url" => "al_dataumum_tertentu_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_tertentu_ver_prov" ] = "al_dataumum_tertentu_ver_prov";
	$projectEntities[ "al_iplt_rev_prov" ] = array( "url" => "al_iplt_rev_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_iplt_rev_prov" ] = "al_iplt_rev_prov";
	$projectEntities[ "al_iplt_rev_pusat" ] = array( "url" => "al_iplt_rev_pusat", "type" => 1 );
	$projectEntitiesReverse[ "al_iplt_rev_pusat" ] = "al_iplt_rev_pusat";
	$projectEntities[ "san_rencanainduk_ver_prov" ] = array( "url" => "san_rencanainduk_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "san_rencanainduk_ver_prov" ] = "san_rencanainduk_ver_prov";
	$projectEntities[ "san_rencanainduk_ver" ] = array( "url" => "san_rencanainduk_ver", "type" => 1 );
	$projectEntitiesReverse[ "san_rencanainduk_ver" ] = "san_rencanainduk_ver";
	$projectEntities[ "mne_umum" ] = array( "url" => "mne_umum", "type" => 0 );
	$projectEntitiesReverse[ "mne_umum" ] = "mne_umum";
	$projectEntities[ "mne_umum_kesiapan" ] = array( "url" => "mne_umum_kesiapan", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_kesiapan" ] = "mne_umum_kesiapan";
	$projectEntities[ "t_mne_tahap" ] = array( "url" => "t_mne_tahap", "type" => 0 );
	$projectEntitiesReverse[ "t_mne_tahap" ] = "t_mne_tahap";
	$projectEntities[ "mne_umum_transisi_pelaksanaan" ] = array( "url" => "mne_umum_transisi_pelaksanaan", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_transisi_pelaksanaan" ] = "mne_umum_transisi_pelaksanaan";
	$projectEntities[ "mne_umum_pelaksanaan" ] = array( "url" => "mne_umum_pelaksanaan", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_pelaksanaan" ] = "mne_umum_pelaksanaan";
	$projectEntities[ "mne_t_jenis_kontrak" ] = array( "url" => "mne_t_jenis_kontrak", "type" => 0 );
	$projectEntitiesReverse[ "mne_t_jenis_kontrak" ] = "mne_t_jenis_kontrak";
	$projectEntities[ "mne_umum_transisi_pasca" ] = array( "url" => "mne_umum_transisi_pasca", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_transisi_pasca" ] = "mne_umum_transisi_pasca";
	$projectEntities[ "mne_umum_pasca" ] = array( "url" => "mne_umum_pasca", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_pasca" ] = "mne_umum_pasca";
	$projectEntities[ "mne_umum_transisi_kesiapan" ] = array( "url" => "mne_umum_transisi_kesiapan", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_transisi_kesiapan" ] = "mne_umum_transisi_kesiapan";
	$projectEntities[ "t_mne_tahap_kekersiapan" ] = array( "url" => "t_mne_tahap_kekersiapan", "type" => 0 );
	$projectEntitiesReverse[ "t_mne_tahap_kekersiapan" ] = "t_mne_tahap_kekersiapan";
	$projectEntities[ "t_mne_tahap_kepasca" ] = array( "url" => "t_mne_tahap_kepasca", "type" => 0 );
	$projectEntitiesReverse[ "t_mne_tahap_kepasca" ] = "t_mne_tahap_kepasca";
	$projectEntities[ "t_mne_tahap_kepelaksanaan" ] = array( "url" => "t_mne_tahap_kepelaksanaan", "type" => 0 );
	$projectEntitiesReverse[ "t_mne_tahap_kepelaksanaan" ] = "t_mne_tahap_kepelaksanaan";
	$projectEntities[ "sp_pemrosesanakhir_ver_prov" ] = array( "url" => "sp_pemrosesanakhir_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_ver_prov" ] = "sp_pemrosesanakhir_ver_prov";
	$projectEntities[ "sp_pemrosesanakhir_ver" ] = array( "url" => "sp_pemrosesanakhir_ver", "type" => 1 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_ver" ] = "sp_pemrosesanakhir_ver";
	$projectEntities[ "al_dataumum_pemukiman_ver" ] = array( "url" => "al_dataumum_pemukiman_ver", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_pemukiman_ver" ] = "al_dataumum_pemukiman_ver";
	$projectEntities[ "al_dataumum_ver" ] = array( "url" => "al_dataumum_ver", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_ver" ] = "al_dataumum_ver";
	$projectEntities[ "al_dataumum_tertentu_ver" ] = array( "url" => "al_dataumum_tertentu_ver", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_tertentu_ver" ] = "al_dataumum_tertentu_ver";
	$projectEntities[ "TPS3R" ] = array( "url" => "tps3r", "type" => 7 );
	$projectEntitiesReverse[ "tps3r" ] = "TPS3R";
	$projectEntities[ "Sanimas" ] = array( "url" => "sanimas", "type" => 7 );
	$projectEntitiesReverse[ "sanimas" ] = "Sanimas";
	$projectEntities[ "PadatKarya" ] = array( "url" => "padatkarya", "type" => 7 );
	$projectEntitiesReverse[ "padatkarya" ] = "PadatKarya";
	$projectEntities[ "san_spm_ald_ver_prov" ] = array( "url" => "san_spm_ald_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "san_spm_ald_ver_prov" ] = "san_spm_ald_ver_prov";
	$projectEntities[ "sp_pengolahan_ver_prov" ] = array( "url" => "sp_pengolahan_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_pengolahan_ver_prov" ] = "sp_pengolahan_ver_prov";
	$projectEntities[ "sp_pengolahan_ver" ] = array( "url" => "sp_pengolahan_ver", "type" => 1 );
	$projectEntitiesReverse[ "sp_pengolahan_ver" ] = "sp_pengolahan_ver";
	$projectEntities[ "Sanimas_prov" ] = array( "url" => "sanimas_prov", "type" => 7 );
	$projectEntitiesReverse[ "sanimas_prov" ] = "Sanimas_prov";
	$projectEntities[ "PadatKarya_prov" ] = array( "url" => "padatkarya_prov", "type" => 7 );
	$projectEntitiesReverse[ "padatkarya_prov" ] = "PadatKarya_prov";
	$projectEntities[ "TPS3R_prov" ] = array( "url" => "tps3r_prov", "type" => 7 );
	$projectEntitiesReverse[ "tps3r_prov" ] = "TPS3R_prov";
	$projectEntities[ "mne_umum_kabkota" ] = array( "url" => "mne_umum_kabkota", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_kabkota" ] = "mne_umum_kabkota";
	$projectEntities[ "tr_pengumuman" ] = array( "url" => "tr_pengumuman", "type" => 0 );
	$projectEntitiesReverse[ "tr_pengumuman" ] = "tr_pengumuman";
	$projectEntities[ "sp_tparegional_ver_prov" ] = array( "url" => "sp_tparegional_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_tparegional_ver_prov" ] = "sp_tparegional_ver_prov";
	$projectEntities[ "sp_tparegional_ver" ] = array( "url" => "sp_tparegional_ver", "type" => 1 );
	$projectEntitiesReverse[ "sp_tparegional_ver" ] = "sp_tparegional_ver";
	$projectEntities[ "sp_banksampah_ver" ] = array( "url" => "sp_banksampah_ver", "type" => 1 );
	$projectEntitiesReverse[ "sp_banksampah_ver" ] = "sp_banksampah_ver";
	$projectEntities[ "sp_banksampah_ver_prov" ] = array( "url" => "sp_banksampah_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_banksampah_ver_prov" ] = "sp_banksampah_ver_prov";
	$projectEntities[ "t_status_keberfungsian" ] = array( "url" => "t_status_keberfungsian", "type" => 0 );
	$projectEntitiesReverse[ "t_status_keberfungsian" ] = "t_status_keberfungsian";
	$projectEntities[ "t_kualitas_keberfungsian" ] = array( "url" => "t_kualitas_keberfungsian", "type" => 0 );
	$projectEntitiesReverse[ "t_kualitas_keberfungsian" ] = "t_kualitas_keberfungsian";
	$projectEntities[ "t_kondisi_fasilitas" ] = array( "url" => "t_kondisi_fasilitas", "type" => 0 );
	$projectEntitiesReverse[ "t_kondisi_fasilitas" ] = "t_kondisi_fasilitas";
	$projectEntities[ "t_kategori_pelayanan" ] = array( "url" => "t_kategori_pelayanan", "type" => 0 );
	$projectEntitiesReverse[ "t_kategori_pelayanan" ] = "t_kategori_pelayanan";
	$projectEntities[ "t_jenis_pengelola" ] = array( "url" => "t_jenis_pengelola", "type" => 0 );
	$projectEntitiesReverse[ "t_jenis_pengelola" ] = "t_jenis_pengelola";
	$projectEntities[ "mne_umum_verifikasi_perencanaan" ] = array( "url" => "mne_umum_verifikasi_perencanaan", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_verifikasi_perencanaan" ] = "mne_umum_verifikasi_perencanaan";
	$projectEntities[ "mne_kesiapan_eval" ] = array( "url" => "mne_kesiapan_eval", "type" => 0 );
	$projectEntitiesReverse[ "mne_kesiapan_eval" ] = "mne_kesiapan_eval";
	$projectEntities[ "mne_pelaksanaan_eval" ] = array( "url" => "mne_pelaksanaan_eval", "type" => 0 );
	$projectEntitiesReverse[ "mne_pelaksanaan_eval" ] = "mne_pelaksanaan_eval";
	$projectEntities[ "mne_pasca_eval" ] = array( "url" => "mne_pasca_eval", "type" => 0 );
	$projectEntitiesReverse[ "mne_pasca_eval" ] = "mne_pasca_eval";
	$projectEntities[ "v_spaldt_kabkota_Report" ] = array( "url" => "v_spaldt_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_spaldt_kabkota_report" ] = "v_spaldt_kabkota_Report";
	$projectEntities[ "v_spaldt_prov" ] = array( "url" => "v_spaldt_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_spaldt_prov" ] = "v_spaldt_prov";
	$projectEntities[ "v_iplt_prov" ] = array( "url" => "v_iplt_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_iplt_prov" ] = "v_iplt_prov";
	$projectEntities[ "v_kesiapan_eval_Report" ] = array( "url" => "v_kesiapan_eval_report", "type" => 2 );
	$projectEntitiesReverse[ "v_kesiapan_eval_report" ] = "v_kesiapan_eval_Report";
	$projectEntities[ "v_pelaksanaan_eval_Report" ] = array( "url" => "v_pelaksanaan_eval_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pelaksanaan_eval_report" ] = "v_pelaksanaan_eval_Report";
	$projectEntities[ "v_pasca_eval_Report" ] = array( "url" => "v_pasca_eval_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pasca_eval_report" ] = "v_pasca_eval_Report";
	$projectEntities[ "v_kesiapan_eval_total_Report" ] = array( "url" => "v_kesiapan_eval_total_report", "type" => 2 );
	$projectEntitiesReverse[ "v_kesiapan_eval_total_report" ] = "v_kesiapan_eval_total_Report";
	$projectEntities[ "v_pelaksanaan_eval_total_Report" ] = array( "url" => "v_pelaksanaan_eval_total_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pelaksanaan_eval_total_report" ] = "v_pelaksanaan_eval_total_Report";
	$projectEntities[ "v_pasca_eval_total_Report" ] = array( "url" => "v_pasca_eval_total_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pasca_eval_total_report" ] = "v_pasca_eval_total_Report";
	$projectEntities[ "v_kesiapan_eval_total_kategori_Report" ] = array( "url" => "v_kesiapan_eval_total_kategori_report", "type" => 2 );
	$projectEntitiesReverse[ "v_kesiapan_eval_total_kategori_report" ] = "v_kesiapan_eval_total_kategori_Report";
	$projectEntities[ "v_pelaksanaan_eval_total_kategori_Report" ] = array( "url" => "v_pelaksanaan_eval_total_kategori_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pelaksanaan_eval_total_kategori_report" ] = "v_pelaksanaan_eval_total_kategori_Report";
	$projectEntities[ "v_pasca_eval_total_kategori_Report" ] = array( "url" => "v_pasca_eval_total_kategori_report", "type" => 2 );
	$projectEntitiesReverse[ "v_pasca_eval_total_kategori_report" ] = "v_pasca_eval_total_kategori_Report";
	$projectEntities[ "al_dataumum_admin" ] = array( "url" => "al_dataumum_admin", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_admin" ] = "al_dataumum_admin";
	$projectEntities[ "v_kesiapan_eval_prov_Report" ] = array( "url" => "v_kesiapan_eval_prov_report", "type" => 2 );
	$projectEntitiesReverse[ "v_kesiapan_eval_prov_report" ] = "v_kesiapan_eval_prov_Report";
	$projectEntities[ "v_al_iplt_keterisian_prov" ] = array( "url" => "v_al_iplt_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_al_iplt_keterisian_prov" ] = "v_al_iplt_keterisian_prov";
	$projectEntities[ "v_sp_pemrosesan_keterisian_prov" ] = array( "url" => "v_sp_pemrosesan_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_sp_pemrosesan_keterisian_prov" ] = "v_sp_pemrosesan_keterisian_prov";
	$projectEntities[ "v_al_iplt_keterisian_kabkota_Report" ] = array( "url" => "v_al_iplt_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_al_iplt_keterisian_kabkota_report" ] = "v_al_iplt_keterisian_kabkota_Report";
	$projectEntities[ "v_sp_pemrosesan_keterisian_kabkota_Report" ] = array( "url" => "v_sp_pemrosesan_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_sp_pemrosesan_keterisian_kabkota_report" ] = "v_sp_pemrosesan_keterisian_kabkota_Report";
	$projectEntities[ "mne_umum_renonly" ] = array( "url" => "mne_umum_renonly", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_renonly" ] = "mne_umum_renonly";
	$projectEntities[ "mne_umum_verifiedonly" ] = array( "url" => "mne_umum_verifiedonly", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_verifiedonly" ] = "mne_umum_verifiedonly";
	$projectEntities[ "mne_kesiapan_penentu" ] = array( "url" => "mne_kesiapan_penentu", "type" => 0 );
	$projectEntitiesReverse[ "mne_kesiapan_penentu" ] = "mne_kesiapan_penentu";
	$projectEntities[ "t_yatidak" ] = array( "url" => "t_yatidak", "type" => 0 );
	$projectEntitiesReverse[ "t_yatidak" ] = "t_yatidak";
	$projectEntities[ "sigdrainase_saluran_drainase" ] = array( "url" => "sigdrainase_saluran_drainase", "type" => 0 );
	$projectEntitiesReverse[ "sigdrainase_saluran_drainase" ] = "sigdrainase_saluran_drainase";
	$projectEntities[ "sigdrainase_kontruksi_drainase" ] = array( "url" => "sigdrainase_kontruksi_drainase", "type" => 0 );
	$projectEntitiesReverse[ "sigdrainase_kontruksi_drainase" ] = "sigdrainase_kontruksi_drainase";
	$projectEntities[ "al_iplt_admin" ] = array( "url" => "al_iplt_admin", "type" => 1 );
	$projectEntitiesReverse[ "al_iplt_admin" ] = "al_iplt_admin";
	$projectEntities[ "sp_pemrosesanakhir_admin" ] = array( "url" => "sp_pemrosesanakhir_admin", "type" => 1 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_admin" ] = "sp_pemrosesanakhir_admin";
	$projectEntities[ "sp_banksampah_admin" ] = array( "url" => "sp_banksampah_admin", "type" => 1 );
	$projectEntitiesReverse[ "sp_banksampah_admin" ] = "sp_banksampah_admin";
	$projectEntities[ "sp_pengolahan_admin" ] = array( "url" => "sp_pengolahan_admin", "type" => 1 );
	$projectEntitiesReverse[ "sp_pengolahan_admin" ] = "sp_pengolahan_admin";
	$projectEntities[ "al_t_jenis_pengolahan_akhir" ] = array( "url" => "al_t_jenis_pengolahan_akhir", "type" => 0 );
	$projectEntitiesReverse[ "al_t_jenis_pengolahan_akhir" ] = "al_t_jenis_pengolahan_akhir";
	$projectEntities[ "al_t_opsi_teknologi" ] = array( "url" => "al_t_opsi_teknologi", "type" => 0 );
	$projectEntitiesReverse[ "al_t_opsi_teknologi" ] = "al_t_opsi_teknologi";
	$projectEntities[ "al_t_sistem_pengolahan" ] = array( "url" => "al_t_sistem_pengolahan", "type" => 0 );
	$projectEntitiesReverse[ "al_t_sistem_pengolahan" ] = "al_t_sistem_pengolahan";
	$projectEntities[ "sigdrainase_sumur" ] = array( "url" => "sigdrainase_sumur", "type" => 0 );
	$projectEntitiesReverse[ "sigdrainase_sumur" ] = "sigdrainase_sumur";
	$projectEntities[ "sigdrainase_kolam_retensi" ] = array( "url" => "sigdrainase_kolam_retensi", "type" => 0 );
	$projectEntitiesReverse[ "sigdrainase_kolam_retensi" ] = "sigdrainase_kolam_retensi";
	$projectEntities[ "v_spaldt_perkotaan_keterisian_prov" ] = array( "url" => "v_spaldt_perkotaan_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_spaldt_perkotaan_keterisian_prov" ] = "v_spaldt_perkotaan_keterisian_prov";
	$projectEntities[ "v_spaldt_permukiman_keterisian_prov" ] = array( "url" => "v_spaldt_permukiman_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_spaldt_permukiman_keterisian_prov" ] = "v_spaldt_permukiman_keterisian_prov";
	$projectEntities[ "v_spaldt_tertentu_keterisian_prov" ] = array( "url" => "v_spaldt_tertentu_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_spaldt_tertentu_keterisian_prov" ] = "v_spaldt_tertentu_keterisian_prov";
	$projectEntities[ "v_sp_pengolahan_keterisian_prov" ] = array( "url" => "v_sp_pengolahan_keterisian_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_sp_pengolahan_keterisian_prov" ] = "v_sp_pengolahan_keterisian_prov";
	$projectEntities[ "v_sp_pengolahan_keterisian_kabkota_Report" ] = array( "url" => "v_sp_pengolahan_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_sp_pengolahan_keterisian_kabkota_report" ] = "v_sp_pengolahan_keterisian_kabkota_Report";
	$projectEntities[ "v_spaldt_perkotaan_keterisian_kabkota_Report" ] = array( "url" => "v_spaldt_perkotaan_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_spaldt_perkotaan_keterisian_kabkota_report" ] = "v_spaldt_perkotaan_keterisian_kabkota_Report";
	$projectEntities[ "v_spaldt_permukiman_keterisian_kabkota_Report" ] = array( "url" => "v_spaldt_permukiman_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_spaldt_permukiman_keterisian_kabkota_report" ] = "v_spaldt_permukiman_keterisian_kabkota_Report";
	$projectEntities[ "v_spaldt_tertentu_keterisian_kabkota_Report" ] = array( "url" => "v_spaldt_tertentu_keterisian_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_spaldt_tertentu_keterisian_kabkota_report" ] = "v_spaldt_tertentu_keterisian_kabkota_Report";
	$projectEntities[ "dra_data_genangan_manual" ] = array( "url" => "dra_data_genangan_manual", "type" => 1 );
	$projectEntitiesReverse[ "dra_data_genangan_manual" ] = "dra_data_genangan_manual";
	$projectEntities[ "sp_t_opsi_teknologi_organik" ] = array( "url" => "sp_t_opsi_teknologi_organik", "type" => 0 );
	$projectEntitiesReverse[ "sp_t_opsi_teknologi_organik" ] = "sp_t_opsi_teknologi_organik";
	$projectEntities[ "v_mne_keterisian_kesiapan" ] = array( "url" => "v_mne_keterisian_kesiapan", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_kesiapan" ] = "v_mne_keterisian_kesiapan";
	$projectEntities[ "v_mne_keterisian_kesiapan_prov" ] = array( "url" => "v_mne_keterisian_kesiapan_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_kesiapan_prov" ] = "v_mne_keterisian_kesiapan_prov";
	$projectEntities[ "v_mne_keterisian_pasca" ] = array( "url" => "v_mne_keterisian_pasca", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_pasca" ] = "v_mne_keterisian_pasca";
	$projectEntities[ "v_mne_keterisian_pasca_prov" ] = array( "url" => "v_mne_keterisian_pasca_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_pasca_prov" ] = "v_mne_keterisian_pasca_prov";
	$projectEntities[ "v_mne_keterisian_pelaksanaan" ] = array( "url" => "v_mne_keterisian_pelaksanaan", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_pelaksanaan" ] = "v_mne_keterisian_pelaksanaan";
	$projectEntities[ "v_mne_keterisian_pelaksanaan_prov" ] = array( "url" => "v_mne_keterisian_pelaksanaan_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_pelaksanaan_prov" ] = "v_mne_keterisian_pelaksanaan_prov";
	$projectEntities[ "v_mne_keterisian_perencanaan" ] = array( "url" => "v_mne_keterisian_perencanaan", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_perencanaan" ] = "v_mne_keterisian_perencanaan";
	$projectEntities[ "v_mne_keterisian_perencanaan_prov" ] = array( "url" => "v_mne_keterisian_perencanaan_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_mne_keterisian_perencanaan_prov" ] = "v_mne_keterisian_perencanaan_prov";
	$projectEntities[ "v_mne_keterisian_kesiapan_kabkota_Report" ] = array( "url" => "v_mne_keterisian_kesiapan_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_mne_keterisian_kesiapan_kabkota_report" ] = "v_mne_keterisian_kesiapan_kabkota_Report";
	$projectEntities[ "v_mne_keterisian_pasca_kabkota_Report" ] = array( "url" => "v_mne_keterisian_pasca_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_mne_keterisian_pasca_kabkota_report" ] = "v_mne_keterisian_pasca_kabkota_Report";
	$projectEntities[ "v_mne_keterisian_pelaksanaan_kabkota_Report" ] = array( "url" => "v_mne_keterisian_pelaksanaan_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_mne_keterisian_pelaksanaan_kabkota_report" ] = "v_mne_keterisian_pelaksanaan_kabkota_Report";
	$projectEntities[ "v_mne_keterisian_perencanaan_kabkota_Report" ] = array( "url" => "v_mne_keterisian_perencanaan_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_mne_keterisian_perencanaan_kabkota_report" ] = "v_mne_keterisian_perencanaan_kabkota_Report";
	$projectEntities[ "sp_pemrosesanakhir_pengembangan" ] = array( "url" => "sp_pemrosesanakhir_pengembangan", "type" => 0 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_pengembangan" ] = "sp_pemrosesanakhir_pengembangan";
	$projectEntities[ "sp_t_opsi_teknologi_anorganik" ] = array( "url" => "sp_t_opsi_teknologi_anorganik", "type" => 0 );
	$projectEntitiesReverse[ "sp_t_opsi_teknologi_anorganik" ] = "sp_t_opsi_teknologi_anorganik";
	$projectEntities[ "v_dra_keterisian_genangan_prov" ] = array( "url" => "v_dra_keterisian_genangan_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_dra_keterisian_genangan_prov" ] = "v_dra_keterisian_genangan_prov";
	$projectEntities[ "v_dra_keterisian_saluran_prov" ] = array( "url" => "v_dra_keterisian_saluran_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_dra_keterisian_saluran_prov" ] = "v_dra_keterisian_saluran_prov";
	$projectEntities[ "v_dra_keterisian_genangan_kabkota_Report" ] = array( "url" => "v_dra_keterisian_genangan_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_dra_keterisian_genangan_kabkota_report" ] = "v_dra_keterisian_genangan_kabkota_Report";
	$projectEntities[ "v_dra_keterisian_saluran_kabkota_Report" ] = array( "url" => "v_dra_keterisian_saluran_kabkota_report", "type" => 2 );
	$projectEntitiesReverse[ "v_dra_keterisian_saluran_kabkota_report" ] = "v_dra_keterisian_saluran_kabkota_Report";
	$projectEntities[ "v_iplt_terverifikasi_Report" ] = array( "url" => "v_iplt_terverifikasi_report", "type" => 2 );
	$projectEntitiesReverse[ "v_iplt_terverifikasi_report" ] = "v_iplt_terverifikasi_Report";
	$projectEntities[ "v_iplt_belum_terverifikasi_Report" ] = array( "url" => "v_iplt_belum_terverifikasi_report", "type" => 2 );
	$projectEntitiesReverse[ "v_iplt_belum_terverifikasi_report" ] = "v_iplt_belum_terverifikasi_Report";
	$projectEntities[ "v_al_dataumum_permukiman_terverifikasi" ] = array( "url" => "v_al_dataumum_permukiman_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_permukiman_terverifikasi" ] = "v_al_dataumum_permukiman_terverifikasi";
	$projectEntities[ "v_al_dataumum_permukiman_belum_terverifikasi" ] = array( "url" => "v_al_dataumum_permukiman_belum_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_permukiman_belum_terverifikasi" ] = "v_al_dataumum_permukiman_belum_terverifikasi";
	$projectEntities[ "v_al_dataumum_perkotaan_terverifikasi" ] = array( "url" => "v_al_dataumum_perkotaan_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_perkotaan_terverifikasi" ] = "v_al_dataumum_perkotaan_terverifikasi";
	$projectEntities[ "v_al_dataumum_perkotaan_belum_terverifikasi" ] = array( "url" => "v_al_dataumum_perkotaan_belum_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_perkotaan_belum_terverifikasi" ] = "v_al_dataumum_perkotaan_belum_terverifikasi";
	$projectEntities[ "v_al_dataumum_tertetu_terverifikasi" ] = array( "url" => "v_al_dataumum_tertetu_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_tertetu_terverifikasi" ] = "v_al_dataumum_tertetu_terverifikasi";
	$projectEntities[ "v_al_dataumum_tertentu_belum_terverifikasi" ] = array( "url" => "v_al_dataumum_tertentu_belum_terverifikasi", "type" => 2 );
	$projectEntitiesReverse[ "v_al_dataumum_tertentu_belum_terverifikasi" ] = "v_al_dataumum_tertentu_belum_terverifikasi";
	$projectEntities[ "al_dataumum_prov" ] = array( "url" => "al_dataumum_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_prov" ] = "al_dataumum_prov";
	$projectEntities[ "al_dataumum_tertentu_prov" ] = array( "url" => "al_dataumum_tertentu_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_tertentu_prov" ] = "al_dataumum_tertentu_prov";
	$projectEntities[ "al_dataumum_permukiman_prov" ] = array( "url" => "al_dataumum_permukiman_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_dataumum_permukiman_prov" ] = "al_dataumum_permukiman_prov";
	$projectEntities[ "al_iplt_prov" ] = array( "url" => "al_iplt_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_iplt_prov" ] = "al_iplt_prov";
	$projectEntities[ "sp_pemrosesanakhir_prov" ] = array( "url" => "sp_pemrosesanakhir_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_pemrosesanakhir_prov" ] = "sp_pemrosesanakhir_prov";
	$projectEntities[ "sp_tparegional_prov" ] = array( "url" => "sp_tparegional_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_tparegional_prov" ] = "sp_tparegional_prov";
	$projectEntities[ "sp_pengolahan_prov" ] = array( "url" => "sp_pengolahan_prov", "type" => 1 );
	$projectEntitiesReverse[ "sp_pengolahan_prov" ] = "sp_pengolahan_prov";
	$projectEntities[ "sigdrainase_saluran_drainase_prov" ] = array( "url" => "sigdrainase_saluran_drainase_prov", "type" => 1 );
	$projectEntitiesReverse[ "sigdrainase_saluran_drainase_prov" ] = "sigdrainase_saluran_drainase_prov";
	$projectEntities[ "dra_data_genangan_prov" ] = array( "url" => "dra_data_genangan_prov", "type" => 1 );
	$projectEntitiesReverse[ "dra_data_genangan_prov" ] = "dra_data_genangan_prov";
	$projectEntities[ "al_spalds" ] = array( "url" => "al_spalds", "type" => 0 );
	$projectEntitiesReverse[ "al_spalds" ] = "al_spalds";
	$projectEntities[ "al_t_suplai_air" ] = array( "url" => "al_t_suplai_air", "type" => 0 );
	$projectEntitiesReverse[ "al_t_suplai_air" ] = "al_t_suplai_air";
	$projectEntities[ "ibm_lpk" ] = array( "url" => "ibm_lpk", "type" => 0 );
	$projectEntitiesReverse[ "ibm_lpk" ] = "ibm_lpk";
	$projectEntities[ "ibm_padatkarya_ver" ] = array( "url" => "ibm_padatkarya_ver", "type" => 0 );
	$projectEntitiesReverse[ "ibm_padatkarya_ver" ] = "ibm_padatkarya_ver";
	$projectEntities[ "ibm_sanimas_ver" ] = array( "url" => "ibm_sanimas_ver", "type" => 0 );
	$projectEntitiesReverse[ "ibm_sanimas_ver" ] = "ibm_sanimas_ver";
	$projectEntities[ "ibm_tps3r_ver" ] = array( "url" => "ibm_tps3r_ver", "type" => 0 );
	$projectEntitiesReverse[ "ibm_tps3r_ver" ] = "ibm_tps3r_ver";
	$projectEntities[ "psn_capaian" ] = array( "url" => "psn_capaian", "type" => 0 );
	$projectEntitiesReverse[ "psn_capaian" ] = "psn_capaian";
	$projectEntities[ "psn_komposisi" ] = array( "url" => "psn_komposisi", "type" => 0 );
	$projectEntitiesReverse[ "psn_komposisi" ] = "psn_komposisi";
	$projectEntities[ "al_spalds_prov" ] = array( "url" => "al_spalds_prov", "type" => 1 );
	$projectEntitiesReverse[ "al_spalds_prov" ] = "al_spalds_prov";
	$projectEntities[ "Dashboard Kabupaten/Kota" ] = array( "url" => "dashboard_kabupaten_kota", "type" => 4 );
	$projectEntitiesReverse[ "dashboard_kabupaten_kota" ] = "Dashboard Kabupaten/Kota";
	$projectEntities[ "dash_persampahan_kabkota" ] = array( "url" => "dash_persampahan_kabkota", "type" => 0 );
	$projectEntitiesReverse[ "dash_persampahan_kabkota" ] = "dash_persampahan_kabkota";
	$projectEntities[ "Dashboard Provinsi" ] = array( "url" => "dashboard_provinsi", "type" => 4 );
	$projectEntitiesReverse[ "dashboard_provinsi" ] = "Dashboard Provinsi";
	$projectEntities[ "dash_airlimbah_kabkota" ] = array( "url" => "dash_airlimbah_kabkota", "type" => 0 );
	$projectEntitiesReverse[ "dash_airlimbah_kabkota" ] = "dash_airlimbah_kabkota";
	$projectEntities[ "dash_airlimbah_nas" ] = array( "url" => "dash_airlimbah_nas", "type" => 0 );
	$projectEntitiesReverse[ "dash_airlimbah_nas" ] = "dash_airlimbah_nas";
	$projectEntities[ "dash_airlimbah_prov" ] = array( "url" => "dash_airlimbah_prov", "type" => 0 );
	$projectEntitiesReverse[ "dash_airlimbah_prov" ] = "dash_airlimbah_prov";
	$projectEntities[ "dash_persampahan_nas" ] = array( "url" => "dash_persampahan_nas", "type" => 0 );
	$projectEntitiesReverse[ "dash_persampahan_nas" ] = "dash_persampahan_nas";
	$projectEntities[ "dash_persampahan_prov" ] = array( "url" => "dash_persampahan_prov", "type" => 0 );
	$projectEntitiesReverse[ "dash_persampahan_prov" ] = "dash_persampahan_prov";
	$projectEntities[ "dash_saluran_drainase_kabkota" ] = array( "url" => "dash_saluran_drainase_kabkota", "type" => 0 );
	$projectEntitiesReverse[ "dash_saluran_drainase_kabkota" ] = "dash_saluran_drainase_kabkota";
	$projectEntities[ "dash_saluran_drainase_nas" ] = array( "url" => "dash_saluran_drainase_nas", "type" => 0 );
	$projectEntitiesReverse[ "dash_saluran_drainase_nas" ] = "dash_saluran_drainase_nas";
	$projectEntities[ "dash_saluran_drainase_prov" ] = array( "url" => "dash_saluran_drainase_prov", "type" => 0 );
	$projectEntitiesReverse[ "dash_saluran_drainase_prov" ] = "dash_saluran_drainase_prov";
	$projectEntities[ "t_al_skalapelayanan" ] = array( "url" => "t_al_skalapelayanan", "type" => 0 );
	$projectEntitiesReverse[ "t_al_skalapelayanan" ] = "t_al_skalapelayanan";
	$projectEntities[ "dash_spaldt_infra" ] = array( "url" => "dash_spaldt_infra", "type" => 0 );
	$projectEntitiesReverse[ "dash_spaldt_infra" ] = "dash_spaldt_infra";
	$projectEntities[ "dash_verifikasi_prov_kabkota" ] = array( "url" => "dash_verifikasi_prov_kabkota", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_prov_kabkota" ] = "dash_verifikasi_prov_kabkota";
	$projectEntities[ "dash_verifikasi_prov_nas" ] = array( "url" => "dash_verifikasi_prov_nas", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_prov_nas" ] = "dash_verifikasi_prov_nas";
	$projectEntities[ "dash_verifikasi_prov_prov" ] = array( "url" => "dash_verifikasi_prov_prov", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_prov_prov" ] = "dash_verifikasi_prov_prov";
	$projectEntities[ "dash_spaldt_infra_prov" ] = array( "url" => "dash_spaldt_infra_prov", "type" => 1 );
	$projectEntitiesReverse[ "dash_spaldt_infra_prov" ] = "dash_spaldt_infra_prov";
	$projectEntities[ "dash_spaldt_infra_kabkota" ] = array( "url" => "dash_spaldt_infra_kabkota", "type" => 1 );
	$projectEntitiesReverse[ "dash_spaldt_infra_kabkota" ] = "dash_spaldt_infra_kabkota";
	$projectEntities[ "v_tpa_prov" ] = array( "url" => "v_tpa_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_tpa_prov" ] = "v_tpa_prov";
	$projectEntities[ "v_tparegional_prov" ] = array( "url" => "v_tparegional_prov", "type" => 0 );
	$projectEntitiesReverse[ "v_tparegional_prov" ] = "v_tparegional_prov";
	$projectEntities[ "dra_data_genangan_ver_prov" ] = array( "url" => "dra_data_genangan_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "dra_data_genangan_ver_prov" ] = "dra_data_genangan_ver_prov";
	$projectEntities[ "dra_data_genangan_ver" ] = array( "url" => "dra_data_genangan_ver", "type" => 1 );
	$projectEntitiesReverse[ "dra_data_genangan_ver" ] = "dra_data_genangan_ver";
	$projectEntities[ "sigdrainase_saluran_drainase_ver_prov" ] = array( "url" => "sigdrainase_saluran_drainase_ver_prov", "type" => 1 );
	$projectEntitiesReverse[ "sigdrainase_saluran_drainase_ver_prov" ] = "sigdrainase_saluran_drainase_ver_prov";
	$projectEntities[ "sigdrainase_saluran_drainase_ver" ] = array( "url" => "sigdrainase_saluran_drainase_ver", "type" => 1 );
	$projectEntitiesReverse[ "sigdrainase_saluran_drainase_ver" ] = "sigdrainase_saluran_drainase_ver";
	$projectEntities[ "dash_verifikasi_pusat_kabkota" ] = array( "url" => "dash_verifikasi_pusat_kabkota", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_pusat_kabkota" ] = "dash_verifikasi_pusat_kabkota";
	$projectEntities[ "dash_verifikasi_pusat_nas" ] = array( "url" => "dash_verifikasi_pusat_nas", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_pusat_nas" ] = "dash_verifikasi_pusat_nas";
	$projectEntities[ "dash_verifikasi_pusat_prov" ] = array( "url" => "dash_verifikasi_pusat_prov", "type" => 0 );
	$projectEntitiesReverse[ "dash_verifikasi_pusat_prov" ] = "dash_verifikasi_pusat_prov";
	$projectEntities[ "sippa_renja1_2018" ] = array( "url" => "sippa_renja1_2018", "type" => 1 );
	$projectEntitiesReverse[ "sippa_renja1_2018" ] = "sippa_renja1_2018";
	$projectEntities[ "sippa_renja1_2019" ] = array( "url" => "sippa_renja1_2019", "type" => 1 );
	$projectEntitiesReverse[ "sippa_renja1_2019" ] = "sippa_renja1_2019";
	$projectEntities[ "sippa_renja1_2020" ] = array( "url" => "sippa_renja1_2020", "type" => 1 );
	$projectEntitiesReverse[ "sippa_renja1_2020" ] = "sippa_renja1_2020";
	$projectEntities[ "sippa_renja1_2021" ] = array( "url" => "sippa_renja1_2021", "type" => 1 );
	$projectEntitiesReverse[ "sippa_renja1_2021" ] = "sippa_renja1_2021";
	$projectEntities[ "sippa_renja1_2022" ] = array( "url" => "sippa_renja1_2022", "type" => 1 );
	$projectEntitiesReverse[ "sippa_renja1_2022" ] = "sippa_renja1_2022";
	$projectEntities[ "simdak_v_rekap_dak" ] = array( "url" => "simdak_v_rekap_dak", "type" => 0 );
	$projectEntitiesReverse[ "simdak_v_rekap_dak" ] = "simdak_v_rekap_dak";
	$projectEntities[ "simdak_v_rekap_drainase" ] = array( "url" => "simdak_v_rekap_drainase", "type" => 0 );
	$projectEntitiesReverse[ "simdak_v_rekap_drainase" ] = "simdak_v_rekap_drainase";
	$projectEntities[ "simdak_v_rekap_ipal" ] = array( "url" => "simdak_v_rekap_ipal", "type" => 0 );
	$projectEntitiesReverse[ "simdak_v_rekap_ipal" ] = "simdak_v_rekap_ipal";
	$projectEntities[ "simdak_v_rekap_ipal_mck" ] = array( "url" => "simdak_v_rekap_ipal_mck", "type" => 0 );
	$projectEntitiesReverse[ "simdak_v_rekap_ipal_mck" ] = "simdak_v_rekap_ipal_mck";
	$projectEntities[ "admin_users" ] = array( "url" => "admin_users", "type" => 1 );
	$projectEntitiesReverse[ "admin_users" ] = "admin_users";
	$projectEntities[ "mne_umum_sippa" ] = array( "url" => "mne_umum_sippa", "type" => 1 );
	$projectEntitiesReverse[ "mne_umum_sippa" ] = "mne_umum_sippa";
	$projectEntities[ "sippa_renja1" ] = array( "url" => "sippa_renja1", "type" => 0 );
	$projectEntitiesReverse[ "sippa_renja1" ] = "sippa_renja1";
}
