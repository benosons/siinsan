...
require_once("include/al_dataumum_tertentu_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "al_dataumum_tertentu_prov" );
