...
require_once("include/sp_banksampah_admin_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_banksampah_admin" );
