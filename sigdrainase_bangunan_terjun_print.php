...
require_once("include/sigdrainase_bangunan_terjun_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_bangunan_terjun" );
