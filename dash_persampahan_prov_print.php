...
require_once("include/dash_persampahan_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dash_persampahan_prov" );
