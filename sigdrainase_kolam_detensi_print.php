...
require_once("include/sigdrainase_kolam_detensi_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_kolam_detensi" );
