...
require_once("include/dash_tparegional_kabkota_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dash_tparegional_kabkota" );
