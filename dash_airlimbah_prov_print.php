...
require_once("include/dash_airlimbah_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dash_airlimbah_prov" );
