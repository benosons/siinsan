...
require_once("include/sigdrainase_pertemuan_air_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_pertemuan_air" );
