...
require_once("include/dash_saluran_drainase_kabkota_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dash_saluran_drainase_kabkota" );
