...
require_once("include/sigdrainase_kontruksi_drainase_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_kontruksi_drainase" );
