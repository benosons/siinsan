...
require_once("include/sigdrainase_saluran_drainase_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_saluran_drainase_prov" );
