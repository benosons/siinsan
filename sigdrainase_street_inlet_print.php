...
require_once("include/sigdrainase_street_inlet_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_street_inlet" );
