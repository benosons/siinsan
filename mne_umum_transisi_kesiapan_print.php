...
require_once("include/mne_umum_transisi_kesiapan_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mne_umum_transisi_kesiapan" );
