...
require_once("include/mne_pascakonstruksi_evaluasi_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mne_pascakonstruksi_evaluasi" );
