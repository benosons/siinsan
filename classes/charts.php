...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("t_kabupatenkota" == $this->chrt_array['tables'][0])
			return true;
		if("t_provinsi" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("siinsan_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_jenis" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_kondisi" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_kategoripelayanan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_jenispengelola" == $this->chrt_array['tables'][0])
			return true;
		if("t_sumber_dana_pembangunan" == $this->chrt_array['tables'][0])
			return true;
		if("t_ada_tidak" == $this->chrt_array['tables'][0])
			return true;
		if("t_ba_status_aset" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pengangkutan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pengolahan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_profil" == $this->chrt_array['tables'][0])
			return true;
		if("san_profil" == $this->chrt_array['tables'][0])
			return true;
		if("t_ada_rusak_tidak" == $this->chrt_array['tables'][0])
			return true;
		if("al_dataumum" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_provinsi" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_kabupatenkota" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_kecamatan" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_kelurahan" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_umum" == $this->chrt_array['tables'][0])
			return true;
		if("t_dra_propinsi" == $this->chrt_array['tables'][0])
			return true;
		if("t_dra_kota" == $this->chrt_array['tables'][0])
			return true;
		if("t_dra_kecamatan" == $this->chrt_array['tables'][0])
			return true;
		if("t_dra_kelurahan" == $this->chrt_array['tables'][0])
			return true;
		if("al_cakupanairlimbah" == $this->chrt_array['tables'][0])
			return true;
		if("al_sdm_institusi" == $this->chrt_array['tables'][0])
			return true;
		if("al_sdm_pengelola" == $this->chrt_array['tables'][0])
			return true;
		if("al_iplt" == $this->chrt_array['tables'][0])
			return true;
		if("al_kualitasair" == $this->chrt_array['tables'][0])
			return true;
		if("al_mck" == $this->chrt_array['tables'][0])
			return true;
		if("al_babs_penderita" == $this->chrt_array['tables'][0])
			return true;
		if("al_penggunasaranabab" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_sektor" == $this->chrt_array['tables'][0])
			return true;
		if("al_programkegiatan" == $this->chrt_array['tables'][0])
			return true;
		if("al_setempat" == $this->chrt_array['tables'][0])
			return true;
		if("al_peranserta" == $this->chrt_array['tables'][0])
			return true;
		if("dra_t_jenis_bahan" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_genangan" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_pembiayaan" == $this->chrt_array['tables'][0])
			return true;
		if("dra_t_bentuk_saluran" == $this->chrt_array['tables'][0])
			return true;
		if("dra_t_jenis_bangunan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_sektor" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_jenis_infrastruktur" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_sumberdana" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_statususulan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_kategori_perencanaan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_tahap_perencanaan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_sub_tahap_perencanaan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_param_sub_tahap_perencanaan" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_pelaksanaan_konstruksi" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_sub_pelaksanaan_konstruksi" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_param_sub_pelaksanaan" == $this->chrt_array['tables'][0])
			return true;
		if("san_spm_stbm" == $this->chrt_array['tables'][0])
			return true;
		if("ssk_file" == $this->chrt_array['tables'][0])
			return true;
		if("ssk_dokumen" == $this->chrt_array['tables'][0])
			return true;
		if("ssk_tahun" == $this->chrt_array['tables'][0])
			return true;
		if("ssk_pokja" == $this->chrt_array['tables'][0])
			return true;
		if("san_profil" == $this->chrt_array['tables'][0])
			return true;
		if("t_verifikasi" == $this->chrt_array['tables'][0])
			return true;
		if("san_spm_stbm" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_sistem" == $this->chrt_array['tables'][0])
			return true;
		if("t_dimanfaatkan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
			return true;
		if("sp_profil_prov" == $this->chrt_array['tables'][0])
			return true;
		if("sp_banksampah" == $this->chrt_array['tables'][0])
			return true;
		if("san_spm_ald" == $this->chrt_array['tables'][0])
			return true;
		if("t_kecamatan" == $this->chrt_array['tables'][0])
			return true;
		if("t_kelurahan" == $this->chrt_array['tables'][0])
			return true;
		if("san_spm_ald" == $this->chrt_array['tables'][0])
			return true;
		if("al_dataumum" == $this->chrt_array['tables'][0])
		...
		if("al_dataumum" == $this->chrt_array['tables'][0])
			return true;
		if("v_tpa" == $this->chrt_array['tables'][0])
			return true;
		if("v_tpa_stat" == $this->chrt_array['tables'][0])
			return true;
		if("usertype" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_pasca_konstruksi" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_sub_pasca_konstruksi" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_param_sub_pasca_konstruksi" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_kriteria_evaluasi" == $this->chrt_array['tables'][0])
			return true;
		if("t_aktif" == $this->chrt_array['tables'][0])
			return true;
		if("san_rencanainduk" == $this->chrt_array['tables'][0])
			return true;
		if("v_tpa_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_tparegional_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_tps3r_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_tpst_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_iplt_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_sanimas_jumlah_by_tahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_pemukiman_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_perkotaan_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_tertentu_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("v_banksampah_jumlah_bytahun" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("v_dra_lokasi_genangan" == $this->chrt_array['tables'][0])
			return true;
		if("san_peraturan" == $this->chrt_array['tables'][0])
			return true;
		if("t_jenis_peraturan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_tpa_alatberat" == $this->chrt_array['tables'][0])
			return true;
		if("sp_tpa_saranapengangkutan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_t_jenis_alatberat" == $this->chrt_array['tables'][0])
			return true;
		if("t_kondisi" == $this->chrt_array['tables'][0])
			return true;
		if("sp_t_jenis_saranaangkut" == $this->chrt_array['tables'][0])
			return true;
		if("t_status_lahan" == $this->chrt_array['tables'][0])
			return true;
		if("al_t_jenis_infrastruktur" == $this->chrt_array['tables'][0])
			return true;
		if("al_cakupanairlimbah" == $this->chrt_array['tables'][0])
			return true;
		if("al_cakupanairlimbah" == $this->chrt_array['tables'][0])
		...
		if("san_rencanainduk" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("t_mne_tahap" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_t_jenis_kontrak" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
		...
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("t_mne_tahap_kekersiapan" == $this->chrt_array['tables'][0])
			return true;
		if("t_mne_tahap_kepasca" == $this->chrt_array['tables'][0])
			return true;
		if("t_mne_tahap_kepelaksanaan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
		...
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("tr_pengumuman" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
		...
		if("sp_banksampah" == $this->chrt_array['tables'][0])
			return true;
		if("t_status_keberfungsian" == $this->chrt_array['tables'][0])
			return true;
		if("t_kualitas_keberfungsian" == $this->chrt_array['tables'][0])
			return true;
		if("t_kondisi_fasilitas" == $this->chrt_array['tables'][0])
			return true;
		if("t_kategori_pelayanan" == $this->chrt_array['tables'][0])
			return true;
		if("t_jenis_pengelola" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_kesiapan_eval" == $this->chrt_array['tables'][0])
			return true;
		if("mne_pelaksanaan_eval" == $this->chrt_array['tables'][0])
			return true;
		if("mne_pasca_eval" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_iplt_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_kesiapan_eval" == $this->chrt_array['tables'][0])
			return true;
		if("v_pelaksanaan_eval" == $this->chrt_array['tables'][0])
			return true;
		if("v_pasca_eval" == $this->chrt_array['tables'][0])
			return true;
		if("v_kesiapan_eval_total" == $this->chrt_array['tables'][0])
			return true;
		if("v_pelaksanaan_eval_total" == $this->chrt_array['tables'][0])
			return true;
		if("v_pasca_eval_total" == $this->chrt_array['tables'][0])
			return true;
		if("v_kesiapan_eval_total_kategori" == $this->chrt_array['tables'][0])
			return true;
		if("v_pelaksanaan_eval_total_kategori" == $this->chrt_array['tables'][0])
			return true;
		if("v_pasca_eval_total_kategori" == $this->chrt_array['tables'][0])
			return true;
		if("al_dataumum" == $this->chrt_array['tables'][0])
			return true;
		if("v_kesiapan_eval" == $this->chrt_array['tables'][0])
			return true;
		if("v_al_iplt_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_sp_pemrosesan_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_al_iplt_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_sp_pemrosesan_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
			return true;
		if("mne_kesiapan_penentu" == $this->chrt_array['tables'][0])
			return true;
		if("t_yatidak" == $this->chrt_array['tables'][0])
			return true;
		if("sigdrainase_saluran_drainase" == $this->chrt_array['tables'][0])
			return true;
		if("sigdrainase_kontruksi_drainase" == $this->chrt_array['tables'][0])
			return true;
		if("al_iplt" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir" == $this->chrt_array['tables'][0])
		...
		if("sp_pengolahan" == $this->chrt_array['tables'][0])
			return true;
		if("al_t_jenis_pengolahan_akhir" == $this->chrt_array['tables'][0])
			return true;
		if("al_t_opsi_teknologi" == $this->chrt_array['tables'][0])
			return true;
		if("al_t_sistem_pengolahan" == $this->chrt_array['tables'][0])
			return true;
		if("sigdrainase_sumur" == $this->chrt_array['tables'][0])
			return true;
		if("sigdrainase_kolam_retensi" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_perkotaan_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_permukiman_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_tertentu_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_sp_pengolahan_keterisian_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_sp_pengolahan_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_perkotaan_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_permukiman_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_spaldt_tertentu_keterisian_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_genangan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_t_opsi_teknologi_organik" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_kesiapan" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_kesiapan_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pasca" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pasca_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pelaksanaan" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pelaksanaan_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_perencanaan" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_perencanaan_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_kesiapan_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pasca_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_pelaksanaan_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_mne_keterisian_perencanaan_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("sp_pemrosesanakhir_pengembangan" == $this->chrt_array['tables'][0])
			return true;
		if("sp_t_opsi_teknologi_anorganik" == $this->chrt_array['tables'][0])
			return true;
		if("v_dra_keterisian_genangan_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_dra_keterisian_saluran_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_dra_keterisian_genangan_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_dra_keterisian_saluran_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("v_iplt" == $this->chrt_array['tables'][0])
			return true;
		if("v_iplt" == $this->chrt_array['tables'][0])
			return true;
		if("v_al_dataumum" == $this->chrt_array['tables'][0])
			return true;
		if("v_al_dataumum" == $this->chrt_array['tables'][0])
			return true;
		if("v_al_dataumum" == $this->chrt_array['tables'][0])
		...
		if("dra_data_genangan" == $this->chrt_array['tables'][0])
			return true;
		if("al_spalds" == $this->chrt_array['tables'][0])
			return true;
		if("al_t_suplai_air" == $this->chrt_array['tables'][0])
			return true;
		if("ibm_lpk" == $this->chrt_array['tables'][0])
			return true;
		if("ibm_padatkarya_ver" == $this->chrt_array['tables'][0])
			return true;
		if("ibm_sanimas_ver" == $this->chrt_array['tables'][0])
			return true;
		if("ibm_tps3r_ver" == $this->chrt_array['tables'][0])
			return true;
		if("psn_capaian" == $this->chrt_array['tables'][0])
			return true;
		if("psn_komposisi" == $this->chrt_array['tables'][0])
			return true;
		if("al_spalds" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dash_persampahan_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("" == $this->chrt_array['tables'][0])
			return true;
		if("dash_airlimbah_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("dash_airlimbah_nas" == $this->chrt_array['tables'][0])
			return true;
		if("dash_airlimbah_prov" == $this->chrt_array['tables'][0])
			return true;
		if("dash_persampahan_nas" == $this->chrt_array['tables'][0])
			return true;
		if("dash_persampahan_prov" == $this->chrt_array['tables'][0])
			return true;
		if("dash_saluran_drainase_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("dash_saluran_drainase_nas" == $this->chrt_array['tables'][0])
			return true;
		if("dash_saluran_drainase_prov" == $this->chrt_array['tables'][0])
			return true;
		if("t_al_skalapelayanan" == $this->chrt_array['tables'][0])
			return true;
		if("dash_spaldt_infra" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_prov_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_prov_nas" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_prov_prov" == $this->chrt_array['tables'][0])
			return true;
		if("dash_spaldt_infra" == $this->chrt_array['tables'][0])
			return true;
		if("dash_spaldt_infra" == $this->chrt_array['tables'][0])
			return true;
		if("v_tpa_prov" == $this->chrt_array['tables'][0])
			return true;
		if("v_tparegional_prov" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_genangan" == $this->chrt_array['tables'][0])
			return true;
		if("dra_data_genangan" == $this->chrt_array['tables'][0])
		...
		if("sigdrainase_saluran_drainase" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_pusat_kabkota" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_pusat_nas" == $this->chrt_array['tables'][0])
			return true;
		if("dash_verifikasi_pusat_prov" == $this->chrt_array['tables'][0])
			return true;
		if("sippa_renja1" == $this->chrt_array['tables'][0])
			return true;
		if("sippa_renja1" == $this->chrt_array['tables'][0])
			return true;
		if("sippa_renja1" == $this->chrt_array['tables'][0])
		...
		if("sippa_renja1" == $this->chrt_array['tables'][0])
			return true;
		if("simdak_v_rekap_dak" == $this->chrt_array['tables'][0])
			return true;
		if("simdak_v_rekap_drainase" == $this->chrt_array['tables'][0])
			return true;
		if("simdak_v_rekap_ipal" == $this->chrt_array['tables'][0])
			return true;
		if("simdak_v_rekap_ipal_mck" == $this->chrt_array['tables'][0])
			return true;
		if("user" == $this->chrt_array['tables'][0])
			return true;
		if("mne_umum" == $this->chrt_array['tables'][0])
