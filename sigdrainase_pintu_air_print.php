...
require_once("include/sigdrainase_pintu_air_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sigdrainase_pintu_air" );
