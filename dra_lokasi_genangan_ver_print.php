...
require_once("include/dra_lokasi_genangan_ver_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dra_lokasi_genangan_ver" );
