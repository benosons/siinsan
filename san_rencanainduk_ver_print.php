...
require_once("include/san_rencanainduk_ver_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "san_rencanainduk_ver" );
