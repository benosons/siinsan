...
require_once("include/sp_pengolahan_admin_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_pengolahan_admin" );
