...
require_once("include/v_dra_keterisian_saluran_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "v_dra_keterisian_saluran_prov" );
