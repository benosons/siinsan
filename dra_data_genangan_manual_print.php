...
require_once("include/dra_data_genangan_manual_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dra_data_genangan_manual" );
