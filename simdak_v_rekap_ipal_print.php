...
require_once("include/simdak_v_rekap_ipal_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "simdak_v_rekap_ipal" );
