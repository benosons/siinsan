...
require_once("include/dash_tparegional_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dash_tparegional_prov" );
