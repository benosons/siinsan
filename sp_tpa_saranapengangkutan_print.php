...
require_once("include/sp_tpa_saranapengangkutan_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_tpa_saranapengangkutan" );
