...
require_once("include/t_al_skalapelayanan_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "t_al_skalapelayanan" );
