...
require_once("include/dra_kontruksi_drainase_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dra_kontruksi_drainase" );
