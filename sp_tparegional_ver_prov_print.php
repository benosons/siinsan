...
require_once("include/sp_tparegional_ver_prov_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "sp_tparegional_ver_prov" );
