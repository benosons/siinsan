...
require_once("include/mne_umum_verifikasi_perencanaan_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mne_umum_verifikasi_perencanaan" );
