...
require_once("include/mne_evaluasi_pelaksanaan_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "mne_evaluasi_pelaksanaan" );
