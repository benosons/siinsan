...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "siinsan_at_localhost";
		$data["connName"] = "siinsan at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;siinsan;S11n54n123$;;siinsan;;1"; //currently unused

		$this->_connectionsIdByName["siinsan at localhost"] = "siinsan_at_localhost";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "siinsan";
		$data["ODBCPWD"] = "S11n54n123$";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "siinsan";
		$data["connInfo"][2] = "S11n54n123$";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "siinsan";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=siinsan;Pwd=S11n54n123$;Database=siinsan;OPTION=3";
		// encription set
		...
		$connectionsData["siinsan_at_localhost"] = $data;
