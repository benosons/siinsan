...
require_once("include/v_all_jumlah_bytahun_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "v_all_jumlah_bytahun" );
