...
require_once("include/al_cakupanairlimbah_tertentu_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "al_cakupanairlimbah_tertentu" );
